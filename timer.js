...
var times = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []];
var ev = ['full', 'ht', 'eo', 'o', 'e', 'c', 'ru', 'lu', 'mu', 'fru', 'rul', 'rru', 'lsll', 'zzls', 'll', 'cmll', 'zbll', '2gll', 'pll', 'cross', 'xcross', '222', '223', 'belt', 'columns'];
...
var scr = function(){
  ...
  if(st == 'columns'){
    return scramblers[333].customScramble([4,5,6,7],[4,5,6,7,8,9,10,11],[4,5,6,7],[0,1,2,3,4,5,6,7]);
  }
};
$('#scramble').html(scr);
